...
echo '(int)((int) $rand->seed * (int) 0x5DEECE66D + 0xB): '. (int)((int) $rand->seed * (int) 0x5DEECE66D + 0xB) . '<BR>';
echo '($rand->seed) : '. ($rand->seed) . '<BR>';
echo '(0x5DEECE66D) : '. (0x5DEECE66D) . '<BR>';
echo '(int)($rand->seed * 0x5DEECE66D) : '.(int)($rand->seed * 0x5DEECE66D) . ' overflow?<BR>';
echo '(int) (160577175182 * 25214903917) : '. (int) (160577175182 * 25214903917) .'<BR>';
echo '(160577175182 * 25214903917) : '. (160577175182 * 25214903917) .'<BR>';
echo '(int)((int)160577175182 * (int)25214903917) : '. (int) ((int)160577175182 * (int)25214903917) .'<BR>';
$test = bcmul (160577175182 , 25214903917);

//echo 'Test A.4: '. (int)(160577175182 * 25214903917) .'<BR>';
echo 'bcmul (160577175182 , 25214903917) : '. bcmul (160577175182 , 25214903917) .'<BR>';
echo '(0xB) : '. (0xB) . '<BR>';
echo '((1 << 48) - 1) : '. ((1 << 48) - 1) . '<BR>'; //Correct
